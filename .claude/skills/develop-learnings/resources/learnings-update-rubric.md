...
This rubric provides quality-validator with specific criteria for evaluating proposed learning entries before they're committed to the learnings files. The goal is to ensure learnings are accurate, reusable, token-efficient, and properly categorized.
