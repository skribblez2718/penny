...
This guide helps the analysis-agent in Phase 1 (Discovery) identify which resolved Unknowns should become candidate learning records, and how to map them to the appropriate cognitive function and pattern type.
