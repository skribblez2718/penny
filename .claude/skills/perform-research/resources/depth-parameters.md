...
**Agent Instructions:**
- **research-discovery:** Prioritize breadth over depth, execute 3-7 focused queries covering main aspects
- **quality-validator:** Apply reduced rigor, focus on major factual errors and critical failures
...
**Agent Instructions:**
- **research-discovery:** Balance breadth and depth, execute 8-15 queries with query decomposition
- **quality-validator:** Apply standard validation rubric without adjustments
...
**Agent Instructions:**
- **research-discovery:** Prioritize depth, execute 15-30+ queries with extensive query decomposition, pursue tangential leads, cross-reference extensively
- **quality-validator:** Apply heightened validation rigor, zero tolerance for Tier 4-5 sources on major claims, require primary sources
...
- If conflicting indicators → Invoke clarification-specialist
