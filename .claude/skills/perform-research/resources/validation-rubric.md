...
This rubric defines quality criteria for research output validation. The quality-validator agent applies these criteria to research findings before synthesis.
