...
- Workflow requires state management across multiple steps
- Deliverables from multiple steps need aggregation
- Final presentation to user is required
- Workflow completion signal must be generated

Do NOT use COORDINATOR for:
- Domain-specific work (delegate to appropriate cognitive function)
- Creating implementation artifacts (use GENERATOR)
- Validating outputs (use VALIDATOR)
...
- Manages workflow state → COORDINATOR candidate
