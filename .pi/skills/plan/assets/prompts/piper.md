...
- **Concrete**: Each step is specific enough to execute without guessing
- **Ordered**: Dependencies are explicit, steps are sequenced correctly
- **Verifiable**: Each step has clear acceptance criteria
- **Resource-aware**: Required resources are identified
- **Risk-aware**: Potential issues are identified upfront
