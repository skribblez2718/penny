# postMessage — Analysis Reference
...
Analyze the code for postMessage / cross-origin messaging vulnerabilities. Check for missing origin validation, wildcard targetOrigin, and dangerous event.data handling.
