...
**Tools to use:**
- **Caido tools** (caido_search, caido_request) for HTTP history — a CSRF verdict
  hinges on whether state-changing requests carry/validate an anti-CSRF token
- **html_parser** (scripts/html_parser.py) for form/DOM structure
