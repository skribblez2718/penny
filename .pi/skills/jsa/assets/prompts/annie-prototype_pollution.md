# Prototype Pollution — Worker Analysis Prompt
...
Analyze the assigned code chunk for Prototype Pollution vulnerabilities. Trace user-controlled input into object merge/extend operations that can pollute `Object.prototype`.
