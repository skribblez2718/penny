...
The agent skill's entire state machine lives in the installed `orchestration`
package (`orchestration.playbooks.agent`); this file only routes
...
if __name__ == "__main__":
    raise SystemExit(main(default_playbook="agent"))
