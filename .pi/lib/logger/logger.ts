...
export interface Logger {
  debug(message: string, context?: Record<string, unknown>, error?: Error & { code?: ErrorCode }): void;
  info(message: string, context?: Record<string, unknown>, error?: Error & { code?: ErrorCode }): void;
  warn(message: string, context?: Record<string, unknown>, error?: Error & { code?: ErrorCode }): void;
  error(message: string, context?: Record<string, unknown>, error?: Error & { code?: ErrorCode }): void;
  critical(message: string, context?: Record<string, unknown>, error?: Error & { code?: ErrorCode }): void;
}
...
const REST_API_KEY = process.env.PI_OBSERVABILITY_API_KEY || process.env.PENNY_OBSERVABILITY_API_KEY || "";
