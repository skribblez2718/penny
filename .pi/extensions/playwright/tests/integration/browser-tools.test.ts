...
describe("Evaluate", () => {
  ...
  it("should evaluate with element selector", async () => {
    await page.setContent('<html><body><ul><li id="a">A</li><li id="b">B</li></ul></body></html>');
...
describe("Form Input", () => {
  ...
  it("should fill an input (replace content)", async () => {
    await page.setContent('<html><body><input id="name" type="text" value="old"></body></html>');
...
describe("Keyboard", () => {
  ...
  it("should press special keys", async () => {
    await page.setContent('<html><body><input id="k1"><input id="k2"></body></html>');
...
describe("Storage", () => {
  ...
  it("should manage cookies", async () => {
    ...
    await page
      .context()
      .addCookies([{ name: "session", value: "abc123", domain: "example.com", path: "/" }]);
...
describe("Routes", () => {
  it("should route and abort requests", async () => {
    ...
    await page.setContent('<html><body><img src="/favicon.ico"></body></html>');
