...
export function registerStorageTools(pi: ExtensionAPI, _config: PlaywrightConfig) {
  ...
  pi.registerTool({
    ...
    label: "Local Storage",
    description:
      "Get, set, or list localStorage entries for the current page origin.",
  ...
  pi.registerTool({
    ...
    description:
      "Get, set, or list sessionStorage entries for the current page origin.",
  ...
  pi.registerTool({
    ...
    description:
      "List, get, set, or clear browser cookies for the current page.",
