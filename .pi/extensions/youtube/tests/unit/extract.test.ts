...
describe("extractVideoId", () => {
  ...
  it("extracts from URL with extra query params", () => {
    expect(extractVideoId("https://www.youtube.com/watch?v=ogTLWGBc3cE&feature=share")).toBe(TEST_VIDEO_ID);
  ...
  it("rejects invalid inputs", () => {
    ...
    expect(() => extractVideoId("https://non-youtube.com/watch?v=ogTLWGBc3cE")).toThrow(/Could not extract/);
  });
