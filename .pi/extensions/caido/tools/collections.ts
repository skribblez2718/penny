...
export async function caidoCollectionsImpl(params: CaidoCollectionsParams, client: Client): Promise<unknown> {
  switch (params.action) {
    ...
    case "rename": {
      if (!params.collection_id || !params.name) throw new Error("collection_id and name are required for rename");
