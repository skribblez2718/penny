...
export function modifyHeaders(headers: string[], removeNames: string[], setHeaders: string[]): string[] {
...
export function buildModifiedRaw(requestLine: string, headers: string[], body: string, lineEnd: string): string {
