...
export async function caidoFindingsImpl(params: CaidoFindingsParams, client: Client): Promise<unknown> {
  switch (params.action) {
    ...
    case "create": {
      if (!params.request_id || !params.title) throw new Error("request_id and title are required for create");
