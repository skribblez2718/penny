import type { Client, CreateFilterPresetOptions } from "@caido/sdk-client";
...
export async function caidoFiltersImpl(
  params: CaidoFiltersParams,
  client: Client
): Promise<unknown> {
  switch (params.action) {
    ...
    case "create": {
      ...
      const createOpts: CreateFilterPresetOptions = {
        name: params.name,
        clause: params.query,
