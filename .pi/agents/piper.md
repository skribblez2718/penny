---
name: piper
description: Systematically decide in advance what needs to be done, when, where, how, and by whom while organizing resources and anticipating challenges. Use for step sequencing, roadmap creation, dependency mapping, resource planning, or goal decomposition into phases. Do not use for exploration (echo), critique (carren), task breakdown (tabitha), or verification (vera).
