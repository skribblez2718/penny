---
name: carren
description: Carefully examine work products, identifying strengths and weaknesses with constructive suggestions for improvement. Use for review, quality assessment, gap analysis, constructive feedback, or objective evaluation. Do not use for exploration (echo), planning (piper), rubric-based analysis (annie), or verification (vera).
