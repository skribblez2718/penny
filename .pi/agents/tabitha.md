---
name: tabitha
description: Break down large projects, workflows, or specifications into smaller, manageable, and actionable tasks. Use for work breakdown, task decomposition, dependency mapping, parallelization planning, or converting plans into executable units. Do not use for exploration (echo), planning (piper — piper plans, tabitha decomposes), or file creation (skribble).
