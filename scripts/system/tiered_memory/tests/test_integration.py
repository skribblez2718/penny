...
class TestArchiveOperation:
    def test_delete_only(self):
        ...
        drawers = [
            DrawerMeta("s1", "penny", "signals", (datetime.now(timezone.utc) - timedelta(days=10)).isoformat()),
            DrawerMeta("s2", "penny", "signals", (datetime.now(timezone.utc) - timedelta(days=10)).isoformat()),
        ]
    ...
    def test_delete_with_archiver(self):
        ...
        drawers = [DrawerMeta("o1", "penny", "outcomes", (datetime.now(timezone.utc) - timedelta(days=31)).isoformat())]
    ...
    def test_delete_failure(self):
        ...
        drawers = [DrawerMeta("x1", "penny", "signals", (datetime.now(timezone.utc) - timedelta(days=10)).isoformat())]
        stats = archive_drawers(drawers, deleter=deleter)
