...
def _get_base_url() -> str:
    ...
    url = os.getenv("PENNY_OBSERVABILITY_URL") or os.getenv("PI_OBSERVABILITY_REST_URL") or DEFAULT_URL
...
def debug(source: str, event: str, session_id: Optional[str] = None, data: Optional[dict[str, Any]] = None) -> None:
    log("DEBUG", source, event, session_id, data)


def info(source: str, event: str, session_id: Optional[str] = None, data: Optional[dict[str, Any]] = None) -> None:
    log("INFO", source, event, session_id, data)


def warn(source: str, event: str, session_id: Optional[str] = None, data: Optional[dict[str, Any]] = None) -> None:
    log("WARN", source, event, session_id, data)


def error(source: str, event: str, session_id: Optional[str] = None, data: Optional[dict[str, Any]] = None) -> None:
    log("ERROR", source, event, session_id, data)


def exception(source: str, event: str, exc: BaseException, session_id: Optional[str] = None) -> None:
