...
class TestFullSelfImprovementFlow:
    ...
    def test_single_domain_pattern_produces_amendment_ready_for_review(self):
        outcomes = [
            {"decision_id": "d1", "outcome": "MISMATCH", "domain": "coding", "reason": "wrong package manager", "session_id": "s1", "confidence_at_action": "POSSIBLE"},
            {"decision_id": "d2", "outcome": "MISMATCH", "domain": "coding", "reason": "wrong package manager", "session_id": "s2", "confidence_at_action": "POSSIBLE"},
        ]
    ...
    def test_universal_learning_blocked_at_every_stage(self):
        outcomes = [
            {"decision_id": "d1", "outcome": "MISMATCH", "domain": "universal", "reason": "Add new confidence level", "session_id": "s1"},
            {"decision_id": "d2", "outcome": "MISMATCH", "domain": "universal", "reason": "Add new confidence level", "session_id": "s2"},
        ]
        amendments = run_compression_loop(outcomes)
    ...
    def test_dedup_prevents_duplicate_proposals(self):
        outcomes = [
            {"decision_id": "d1", "outcome": "MISMATCH", "domain": "coding", "reason": "same issue", "session_id": "s1"},
            {"decision_id": "d2", "outcome": "MISMATCH", "domain": "coding", "reason": "same issue", "session_id": "s2"},
        ]
    ...
    def test_multiple_patterns_produce_multiple_amendments(self):
        outcomes = [
            {"decision_id": "d1", "outcome": "MISMATCH", "domain": "coding", "reason": "wrong package manager", "session_id": "s1"},
            {"decision_id": "d2", "outcome": "MISMATCH", "domain": "coding", "reason": "wrong package manager", "session_id": "s1"},
            {"decision_id": "d3", "outcome": "MISMATCH", "domain": "planning", "reason": "missed dependencies", "session_id": "s2"},
            {"decision_id": "d4", "outcome": "MISMATCH", "domain": "planning", "reason": "missed dependencies", "session_id": "s2"},
        ]
        amendments = run_compression_loop(outcomes)
    ...
    def test_match_only_outcomes_produce_no_amendments(self):
        outcomes = [
            {"decision_id": "d1", "outcome": "MATCH", "domain": "coding", "reason": "ok", "session_id": "s1"},
            {"decision_id": "d2", "outcome": "MATCH", "domain": "coding", "reason": "ok", "session_id": "s2"},
        ]
        amendments = run_compression_loop(outcomes)
        assert amendments == []
