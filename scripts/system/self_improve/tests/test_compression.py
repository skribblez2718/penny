...
class TestIdentifyPatterns:
    ...
    def test_single_mismatch_no_pattern(self):
        outcomes = [
            {"decision_id": "d1", "outcome": "MISMATCH", "domain": "coding", "reason": "wrong assumption"}
        ]
    ...
    def test_repeated_domain_pattern_detected(self):
        outcomes = [
            {"decision_id": "d1", "outcome": "MISMATCH", "domain": "coding", "reason": "wrong package manager"},
            {"decision_id": "d2", "outcome": "MISMATCH", "domain": "coding", "reason": "wrong package manager"},
            {"decision_id": "d3", "outcome": "PARTIAL", "domain": "coding", "reason": "wrong package manager"},
        ]
        patterns = identify_patterns(outcomes)
    ...
    def test_multiple_separate_patterns(self):
        outcomes = [
            {"decision_id": "d1", "outcome": "MISMATCH", "domain": "coding", "reason": "wrong package manager"},
            {"decision_id": "d2", "outcome": "MISMATCH", "domain": "coding", "reason": "wrong package manager"},
            {"decision_id": "d3", "outcome": "MISMATCH", "domain": "planning", "reason": "missed dependencies"},
            {"decision_id": "d4", "outcome": "MISMATCH", "domain": "planning", "reason": "missed dependencies"},
        ]
        patterns = identify_patterns(outcomes)
    ...
    def test_ignores_match_outcomes(self):
        outcomes = [
            {"decision_id": "d1", "outcome": "MATCH", "domain": "coding", "reason": "everything fine"},
            {"decision_id": "d2", "outcome": "MATCH", "domain": "coding", "reason": "everything fine"},
        ]
        patterns = identify_patterns(outcomes)
        assert patterns == []
    ...
    def test_ignores_single_occurrence(self):
        outcomes = [
            {"decision_id": "d1", "outcome": "MISMATCH", "domain": "coding", "reason": "unique issue"},
            {"decision_id": "d2", "outcome": "MISMATCH", "domain": "coding", "reason": "other unique issue"},
        ]
        patterns = identify_patterns(outcomes)
        assert patterns == []
...
class TestRunCompressionLoop:
    ...
    def test_patterns_generate_amendments(self):
        outcomes = [
            {"decision_id": "d1", "outcome": "MISMATCH", "domain": "coding", "reason": "assumed uv without checking"},
            {"decision_id": "d2", "outcome": "MISMATCH", "domain": "coding", "reason": "assumed uv without checking"},
            {"decision_id": "d3", "outcome": "MISMATCH", "domain": "coding", "reason": "assumed uv without checking"},
        ]
        result = run_compression_loop(outcomes)
        assert len(result) >= 1
        amendment = result[0]
    ...
    def test_universal_learnings_get_rejected(self):
        outcomes = [
            {"decision_id": "d1", "outcome": "MISMATCH", "domain": "universal", "reason": "should add before responding step"},
            {"decision_id": "d2", "outcome": "MISMATCH", "domain": "universal", "reason": "should add before responding step"},
        ]
        result = run_compression_loop(outcomes)
        assert len(result) >= 1
    ...
    def test_dedup_prevents_duplicate_amendments(self):
        ...
        outcomes = [
            {"decision_id": "d1", "outcome": "MISMATCH", "domain": "coding", "reason": "same issue"},
            {"decision_id": "d2", "outcome": "MISMATCH", "domain": "coding", "reason": "same issue"},
        ]
