...
- [Skills](skills/AGENTS.md): Domain Guidance layer — skill prompts, scaffolding, conventions
- [Prompts](prompts/AGENTS.md): Layer Reference, standards, cognitive frame, role definitions
- [Memory](memory/AGENTS.md): Tool reference, storage patterns, best practices, and error handling
- [Observability Server](observability-server/AGENTS.md): FastAPI + SQLite event/log ingestion, REST query API, and watcher logs for agent diagnostics
