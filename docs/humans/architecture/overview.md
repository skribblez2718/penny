...
Penny skills use `python-statemachine` to declare states, transitions, guards, and callbacks. This makes the current phase always visible, lets failures route to recovery states, and makes long skills resumable.
